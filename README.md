...
**[Vet_clinic]**  is a project to consolidate your knowledge about sql queries,
...
In order to run this project you need to install postgresql<br>
...
Clone this repository to your desired folder:
  ...
  cd my-folder<br>
 `git clone https://github.com/Armynerh/vet_clinic`
